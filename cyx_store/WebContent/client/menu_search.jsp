	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:center; ">
				...
				<input type="text" name="textfield" class="inputtable" id="textfield" value="请输入商品的英文名"
...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/showProductByPage" style="color:#b4d76d; font-size:20px;">全部商品目录</a>		
</div>
