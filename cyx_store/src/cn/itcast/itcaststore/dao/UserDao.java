...
public class UserDao {
	 ...
	 * new QueryRunner(DataSourceUtils.getDataSource()); return runner.query(sql,
	...
	// 激活用戶
	/*
	 * public void activeUser(String activeCode) throws SQLException { String sql =
	 * "update user set state=? where activecode=?"; QueryRunner runner = new
	 * QueryRunner(DataSourceUtils.getDataSource()); runner.update(sql, 1,
	 * activeCode); }
	 */
